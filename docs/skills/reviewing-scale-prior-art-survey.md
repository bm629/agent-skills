...
**46 numbered conditions**, contiguous, grouped per kind — plus one group headed `## Every kind`,
...
is this document's declaration of the result rather than a second copy of it. It lands SIX
