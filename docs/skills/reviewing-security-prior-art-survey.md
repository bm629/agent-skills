...
nine for the extract record, seven for the threat register, and one applying to every kind. The breakdown is the checkable half: a total corrected on its own summed to thirty-seven
