...
description: >
  ...
  technical-design, architecture-doc + its linked ADRs, data-model, or api-spec
  artifacts (each routes to its dedicated reviewing-* twin). Keywords: design
  review, spec/plan/RFC/ADR review, gap analysis.
extensions:
  claude:
