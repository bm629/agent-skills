...
findings:
  - id: DOI-10.1145/3313831.3376283#f1
    ...
    transferability:
      level: moderate
      reason: >
        A between-subjects controlled study with 240 participants comparing a flat panel against
        a progressive-disclosure variant, reporting d=0.42 on time-to-task.
...
Between-subjects controlled study, n=240, desktop web, comparing a flat settings panel against
a progressive-disclosure variant.
