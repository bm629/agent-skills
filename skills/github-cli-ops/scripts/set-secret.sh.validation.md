# Validation — `set-secret.sh`

**What it does:** CLI path — `gh secret set` (gh encrypts the value client-side; no hand-rolled libsodium).

**Static validation (2026-05-31):**
- `bash -n set-secret.sh` → pass (syntax OK).
