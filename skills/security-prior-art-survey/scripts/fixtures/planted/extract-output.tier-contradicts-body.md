...
tier: 1
tier_evidence:
- kind: matching-incident
  reference: industry incident reporting, expense-fraud category
...
lists it, and the incident corpora record no exploitation of it against any product class.
